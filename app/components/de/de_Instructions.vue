  ...
  <div class="instructions">
    ...
    <ol class="instructions__list">
      <li class="instructions__item instruction">
        <span class="instruction__text" v-once>Bewerte die Enden von {{ sentenceCount }} Sätzen:<br> 4 ist die höchste <br>1 die niedrigste Punktzahl</span>
      </li>
      <li class="instructions__item instruction">
...
<script type="module">
    import Instructions_base from '../Instructions_base.vue'
    export default {
        mixins: [Instructions_base],
      }
</script>
